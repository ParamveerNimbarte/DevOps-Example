node {
    ...
    stage('Deploy Docker Image and login'){
      ...
      echo "Docker Image Tag Name: ${dockerImageTag}"
        ...
        sh "docker images"
        sh "docker login -u paramveernimbarte -p PammO@1998" // put PWD
	...
	//sh "read imageid"
	   sh "docker tag 8a7554311811 paramveernimbarte/myapplication" //must change your name and tag no
        sh "docker push   paramveernimbarte/myapplication"
  }
}
